...
def prepare(kicid, archive_root, results_root, injections=None,
            durations=[0.2, 0.4, 0.6, 0.8], min_period=50, max_period=725):
...
def generate_system(K, mstar=1.0, rstar=1.0, min_period=50., max_period=725.):
...
def main(args):
    ...
    if args.get("injections", 0) > 0:
        ...
        injections = generate_system(args.get("injections", 0),
                                     ...
                                     max_period=args.get("max_period", 725.0))
